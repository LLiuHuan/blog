...
<template>
  <div class="page-main">
    ...
    <button class="prev" @click="Prev" :disabled="prevDisabled" :aria-disabled="prevDisabled">
    ...
    <button class="next" @click="Next" :disabled="nextDisabled" :aria-disabled="nextDisabled">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const nextDisabled = computed(
        () => state.currentPage === state.pageCount || state.pageCount === 0
      );
      ...
      const prevDisabled = computed(() => state.currentPage === 1 || state.pageCount === 0);
