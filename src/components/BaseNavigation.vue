...
<template>
  <div id="navigation" class="meun content content_ba">
    <div class="meun_nav">
      ...
      <div class="meun_list">
        <ul class="meun_ul">
          <li v-for="val in data" class="meun_li" :class="{current: modelValue === val.key}">
            <router-link v-if="val.url" :to="val.url" @click="setCurrent(val.key)">
              {{ val.value }}
            </router-link>
          </li>
        </ul>
        <div class="search_btn" @click="mobile_open = true"><i class="iconfont icon-caidan"></i></div>
  ...
  <div class="pjax_in">
    <div class="mobile " :class="{mobile_open: mobile_open}">
      ...
      <div class="mobile_meun">
        <ul class="mobile_ul">
          <li v-for="val in data" class="mobile_li">
    ...
    <!--磨砂背景-->
    <div @click="mobile_open = false" class="sap_mask mobile_mask" :class="{sap_open: mobile_open}"></div>
  </div>
</template>
