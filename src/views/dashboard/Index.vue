      ...
      <article class="main_sm_list">
        <div class="main_sm_right ">
          <h2 class="main_sm_title">
            <router-link :to="{name: 'article', query: {id: 123}}"><span class="index_top">置顶</span>我在干嘛</router-link>
          </h2>
          <div class="main_sm_time">In <span><a href="https://fasxx.com/category/xinqing/">心情</a></span> at
            <time datetime="2021-06-20T23:22:00+08:00">2021-06-20</time>
          </div>
          <div class="main_sm_excerpt">
            最近工作比较忙也很久没打理博客了今天呢闲着没事把之前的文章都删了反正就是写了又删 删了又写生命的乐趣不就在于折腾吗
          </div>

          <div class="main_sm_foot">
            <span class="more"><a href="https://fasxx.com/405/.html">Read more</a> <i class="iconfont icon-arrdown"></i></span>
            <span class="liuyan"><i class="iconfont icon-comment"></i> 4</span>
          </div>
        </div>
      </article>
      <!--大图-->
      <article v-for="i in t1" class="main_bg_list">
        <div class="main_bg_info">
          ...
          <div class="main_bg_post">
            <h2 class="main_bg_title"><a href="https://fasxx.com/415/.html">如果你懂我的奇奇怪怪</a></h2>

            <div class="main_bg_excerpt">
              那你一定可可爱爱
            </div>

            <div class="main_bg_foot">
              <span class="more"><a href="https://fasxx.com/415/.html">Read more</a> <i
                  class="iconfont icon-arrdown"></i></span>
